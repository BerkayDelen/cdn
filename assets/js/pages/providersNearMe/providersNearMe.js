            ...
            columnDefs: [
                {
                    ...
                    render: function (data, type, full, meta) {
                        var locationItem = `
<div class="row location-item mt-1">
    <div class="col-md-12 col-sm-12">
       <span class="font-blue">Location Name:</span> `+ full.locationName + `
    </div>
    <div class="div-hr mt-3 mb-3"></div>
    <div class="col-md-12 col-sm-12">
       <span class="font-blue">Partner Name:</span> `+ full.locationPartner.name + `
    </div>
    <div class="div-hr mt-3 mb-3"></div>
    <div class="col-md-12 col-sm-12">
       <span class="font-blue">Business Name:</span>  `+ full.locationBusiness.name + `
    </div>
...
$(function () {
    providersNearMe.productCategoryButton();
    providersNearMe.searchButton();
    providersNearMe.countryList();
    providersNearMe.initDataTable();
    providersNearMe.initMap();
});